...
namespace DJM.CoreUtilities
{
    ...
    public sealed class CanvasGroupFader : MonoBehaviour
    {
        ...
        /// <param name="unscaledTransitionTime">The duration it takes for the alpha to transition either from 0 to 1 or from 1 to 0. The actual transition time will scale based on the current alpha and the target alpha.</param>
        ...
        public IEnumerator FadeCanvasGroupAlphaCoroutine(float targetAlpha, float unscaledTransitionTime, Ease ease)
        {
            var fadeDuration = Mathf.Abs(_canvasGroup.alpha - targetAlpha) * unscaledTransitionTime;
